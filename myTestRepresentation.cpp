/*=========================================================================
  ...
  Module:    myTestRepresentation.cxx
...
vtkStandardNewMacro(myTestRepresentation);


//----------------------------------------------------------------------
myTestRepresentation::myTestRepresentation() : vtkBiDimensionalRepresentation()
{
...
//----------------------------------------------------------------------
myTestRepresentation::~myTestRepresentation()
{
...
ComputeInteractionState(int X, int Y, int modify)
{
	...
	{
		this->InteractionState = myTestRepresentation::NearP1;
	}
	else if (p2State == vtkHandleRepresentation::Nearby)
	{
		this->InteractionState = myTestRepresentation::NearP2;
	}
	else if (p3State == vtkHandleRepresentation::Nearby)
	{
		this->InteractionState = myTestRepresentation::NearP3;
	}
	else if (p4State == vtkHandleRepresentation::Nearby)
	{
		this->InteractionState = myTestRepresentation::NearP4;
	}
	else
	{
		this->InteractionState = myTestRepresentation::Outside;
	}

	// Okay if we're near a handle return, otherwise test edges.
	if (this->InteractionState != myTestRepresentation::Outside)
	{
	...
	if (onL1 && onL2)
	{
		this->InteractionState = myTestRepresentation::OnCenter;
	}
	else if (onL1)
	{
		if (p1[0] != p2[0])
		{
			...
			if (xyzParam < uIntersect)
			{
				...
				{
					this->InteractionState = myTestRepresentation::OnL1Outer;
				}
				else
				{
					this->InteractionState = myTestRepresentation::OnL1Inner;
				}
			}
			else
			{
	...
	else if (onL2)
	{
		if (p3[0] != p4[0])
		{
			...
			if (xyzParam < vIntersect)
			{
				...
				{
					this->InteractionState = myTestRepresentation::OnL2Outer;
				}
				else
				{
					this->InteractionState = myTestRepresentation::OnL2Inner;
				}
			}
			else
			{
...
//----------------------------------------------------------------------
void myTestRepresentation::StartWidgetDefinition(double e[2])
{
	double pos[3];
	pos[0] = e[0];
	pos[1] = e[1];
...
//----------------------------------------------------------------------
void myTestRepresentation::Point2WidgetInteraction(double e[2])
{
	double pos[3], p1[3];
	pos[0] = e[0];
	pos[1] = e[1];
...
void myTestRepresentation::Point3WidgetInteraction(double e[2])
{
...
//----------------------------------------------------------------------
void myTestRepresentation::StartWidgetManipulation(double e[2])
{
...
void myTestRepresentation::ProjectOrthogonalPoint(double x[4], double y[3], double x1[3], double x2[3],
...
void myTestRepresentation::WidgetInteraction(double e[2])
{
...
//----------------------------------------------------------------------
void myTestRepresentation::BuildRepresentation()
{
...
//----------------------------------------------------------------------
char* myTestRepresentation::GetLabelText()
{
	return this->TextMapper->GetInput();
}

//----------------------------------------------------------------------
double* myTestRepresentation::GetLabelPosition()
{
	return this->TextActor->GetPosition();
}

//----------------------------------------------------------------------
void myTestRepresentation::GetLabelPosition(double pos[3])
{
	this->TextActor->GetPositionCoordinate()->GetValue(pos);
}

//----------------------------------------------------------------------
void myTestRepresentation::GetWorldLabelPosition(double pos[3])
{
...
//----------------------------------------------------------------------
void myTestRepresentation::ReleaseGraphicsResources(vtkWindow *w)
{
...
//----------------------------------------------------------------------
int myTestRepresentation::RenderOverlay(vtkViewport *viewport)
{
...
//----------------------------------------------------------------------
void myTestRepresentation::Highlight(int highlightOn)
{
	if (highlightOn)
	{
...
//----------------------------------------------------------------------
void myTestRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
