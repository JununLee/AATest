/*=========================================================================
  ...
  Module:    vtkImageActorPointPlacerLTY.h
...
=========================================================================*/
/**
 * @class   vtkImageActorPointPlacerLTY
...
#ifndef vtkImageActorPointPlacerLTY_h
#define vtkImageActorPointPlacerLTY_h
...
class vtkImageActorPointPlacerLTY : public vtkPointPlacer
{
public:
	/**
	 * Instantiate this class.
	 */
	static vtkImageActorPointPlacerLTY *New();

	//@{
	/**
	 * Standard methods for instances of this class.
	 */
	vtkTypeMacro(vtkImageActorPointPlacerLTY, vtkPointPlacer);
...
protected:
	vtkImageActorPointPlacerLTY();
	~vtkImageActorPointPlacerLTY() override;
...
private:
	vtkImageActorPointPlacerLTY(const vtkImageActorPointPlacerLTY&) = delete;
	void operator=(const vtkImageActorPointPlacerLTY&) = delete;
};
