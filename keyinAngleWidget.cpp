...
vtkStandardNewMacro(keyinAngleWidget);
...
//----------------------------------------------------------------------
keyinAngleWidget::keyinAngleWidget()
{
	this->ManagesCursor = 0;

	this->WidgetState = keyinAngleWidget::Start;
	...
	this->CallbackMapper->SetCallbackMethod(vtkCommand::LeftButtonPressEvent,
		...
		this, keyinAngleWidget::AddPointAction);
	this->CallbackMapper->SetCallbackMethod(vtkCommand::MouseMoveEvent,
		vtkWidgetEvent::Move,
		this, keyinAngleWidget::MoveAction);
	this->CallbackMapper->SetCallbackMethod(vtkCommand::LeftButtonReleaseEvent,
		vtkWidgetEvent::EndSelect,
		this, keyinAngleWidget::EndSelectAction);

	this->CallbackMapper->SetCallbackMethod(vtkCommand::KeyPressEvent,
		vtkEvent::NoModifier, 8, 1, "BackSpace",
		vtkWidgetEvent::Delete,
		this, keyinAngleWidget::DeleteWidget);
}
...
//----------------------------------------------------------------------
void keyinAngleWidget::CreateDefaultRepresentation()
{
	if (!this->WidgetRep)
	{
...
//----------------------------------------------------------------------
void keyinAngleWidget::SetEnabled(int enabling)
{
	...
	if (enabling)
	{
		if (this->WidgetState == keyinAngleWidget::Start)
		{
			if (this->WidgetRep)
			{
				reinterpret_cast<vtkAngleRepresentation*>(this->WidgetRep)->
	...
	if (enabling) //----------------
	{
		...
		if (rep)
		{
			rep->SetRay1Visibility(
				this->WidgetState != keyinAngleWidget::Start ? 1 : 0);
...
//----------------------------------------------------------------------
vtkTypeBool keyinAngleWidget::IsAngleValid()
{
	if (this->WidgetState == keyinAngleWidget::Manipulate ||
		(this->WidgetState == keyinAngleWidget::Define && this->CurrentHandle == 2))
	{
		return 1;
	}
	else
...
//-------------------------------------------------------------------------
void keyinAngleWidget::AddPointAction(vtkAbstractWidget *w)
{
	keyinAngleWidget *self = reinterpret_cast<keyinAngleWidget*>(w);
	int X = self->Interactor->GetEventPosition()[0];
	int Y = self->Interactor->GetEventPosition()[1];

	// If we are placing the first point it's easy
	if (self->WidgetState == keyinAngleWidget::Start)
	{
		self->GrabFocus(self->EventCallbackCommand);
		self->WidgetState = keyinAngleWidget::Define;
	...
	else if (self->WidgetState == keyinAngleWidget::Define)
	{
		self->InvokeEvent(vtkCommand::PlacePointEvent, &(self->CurrentHandle));
		...
		{
			self->WidgetState = keyinAngleWidget::Manipulate;
	...
	else //if ( self->WidgetState == keyinAngleWidget::Manipulate )
	{
...
//-------------------------------------------------------------------------
void keyinAngleWidget::MoveAction(vtkAbstractWidget *w)
{
	keyinAngleWidget *self = reinterpret_cast<keyinAngleWidget*>(w);
	...
	if (self->WidgetState == keyinAngleWidget::Define)
	{
		int X = self->Interactor->GetEventPosition()[0];
		int Y = self->Interactor->GetEventPosition()[1];
		double e[2];
...
//-------------------------------------------------------------------------
void keyinAngleWidget::EndSelectAction(vtkAbstractWidget *w)
{
	keyinAngleWidget *self = reinterpret_cast<keyinAngleWidget*>(w);
...
void keyinAngleWidget::DeleteWidget(vtkAbstractWidget *w)
{
	keyinAngleWidget *self = reinterpret_cast<keyinAngleWidget*>(w);
	keyinAngleRepresentation *rep = reinterpret_cast<keyinAngleRepresentation*>(self->WidgetRep);
	...
	pos[0] = X;
	pos[1] = Y;
	if(rep->GetArc()->MouseOverLabel(pos))
		self->SetEnabled(0);
}
...
//----------------------------------------------------------------------
void keyinAngleWidget::StartAngleInteraction(int)
{
...
//----------------------------------------------------------------------
void keyinAngleWidget::AngleInteraction(int)
{
	this->InvokeEvent(vtkCommand::InteractionEvent, nullptr);
}

//----------------------------------------------------------------------
void keyinAngleWidget::EndAngleInteraction(int)
{
...
//----------------------------------------------------------------------
void keyinAngleWidget::SetProcessEvents(vtkTypeBool pe)
{
...
//----------------------------------------------------------------------
void keyinAngleWidget::SetWidgetStateToStart()
{
	this->WidgetState = keyinAngleWidget::Start;
...
//----------------------------------------------------------------------
void keyinAngleWidget::SetWidgetStateToManipulate()
{
	this->WidgetState = keyinAngleWidget::Manipulate;
	this->CurrentHandle = -1;
	this->ReleaseFocus();
	this->GetRepresentation()->BuildRepresentation(); // update this->Angle
	this->SetEnabled(this->GetEnabled()); // show/hide the handles properly
...
//----------------------------------------------------------------------
void keyinAngleWidget::PrintSelf(ostream& os, vtkIndent indent)
{
